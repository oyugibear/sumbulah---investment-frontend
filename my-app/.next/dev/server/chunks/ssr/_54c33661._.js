...
"[project]/lib/services/news-service.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getFinanceNews(page = 1, limit = 20) {
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/news/finance?page=${page}&limit=${limit}`);
...
async function getNewsByCategory(category, page = 1, limit = 20) {
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/news/category/${category}?page=${page}&limit=${limit}`);
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isApiSuccess"])(response)) {
...
async function getRelevantNews(minRelevance = 0.7, page = 1, limit = 20) {
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/news/relevant?minRelevance=${minRelevance}&page=${page}&limit=${limit}`);
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isApiSuccess"])(response)) {
...
async function getNewsArticle(id) {
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/news/${id}`);
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isApiSuccess"])(response)) {
...
async function searchNews(query, category, page = 1, limit = 20) {
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/news/search?${params}`);
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isApiSuccess"])(response)) {
...
async function refreshNews() {
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post('/news/refresh');
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isApiSuccess"])(response)) {
...
async function getNewsStats() {
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get('/news/stats/summary');
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isApiSuccess"])(response)) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$news$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/services/news-service.ts [app-ssr] (ecmascript)");
...
function NewsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const loadNews = async ()=>{
            try {
                ...
                let data = [];
                if (filter === "all") {
                    data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$news$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getFinanceNews"])(1, 10); // Fetch 10 items
                } else if (filter === "relevant") {
                    data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$news$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getRelevantNews"])(0.7, 1, 10); // Fetch 10 items
                } else {
                    data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$news$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getNewsByCategory"])(filter, 1, 10); // Fetch 10 items
                }
                setNews(data);
    ...
    const loadMoreNews = async ()=>{
        ...
        try {
            ...
            let moreData = [];
            if (filter === "all") {
                moreData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$news$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getFinanceNews"])(nextPage, 10);
            } else if (filter === "relevant") {
                moreData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$news$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getRelevantNews"])(0.7, nextPage, 10);
            } else {
                moreData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$news$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getNewsByCategory"])(filter, nextPage, 10);
            }
                ...
                children: [
                    ...
                    loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                article.relevanceScore >= 8 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            !loading && news.length > 0 && hasMore && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_54c33661._.js.map