...
export const translations = {
  en: {
    ...
    home: {
      ...
      insightDesc:
        "Based on your spending patterns, you're on track to invest around 80-100 SAR per month through round-ups alone. Keep it up!",
    ...
    portfolios: {
      ...
      aboutDesc:
        "All portfolios invest exclusively in domestic Saudi assets and are structured to comply with Shariah principles. Fees are kept low with a flat subscription model. This is a demonstration - actual portfolios would be managed by licensed professionals.",
    ...
    learn: {
      ...
      whyLearn: "Why Learn?",
      whyLearnDesc:
        "Understanding the basics of investing helps you make informed decisions and stay confident during market changes. Each article takes just 2-3 minutes to read.",
    ...
    investment: {
      ...
      riskDisclosureDesc:
        "While partner bank investments are generally lower risk, past performance does not guarantee future results. Expected profits are not guaranteed and may vary based on market conditions. This investment is backed by the partner bank's balance sheet and regulatory oversight by SAMA.",
      isGuaranteed: "Is this a guaranteed investment?",
      isGuaranteedDesc:
        "Expected profits are based on partner bank performance. While backed by the bank, market conditions can affect returns.",
      canWithdrawEarly: "Can I withdraw early?",
      canWithdrawEarlyDesc:
        "Withdrawals are typically processed at year-end. Early redemptions may apply terms as per contract.",
      isShariahCompliant: "Is this Shariah-compliant?",
      isShariahCompliantDesc:
        "Yes. All investments are in Shariah-compliant instruments like Sukuk and Islamic bonds certified by Islamic financial scholars.",
      howTaxesCalculated: "How are taxes calculated?",
      howTaxesCalculatedDesc:
        "Currently, no applicable taxes on investment returns. Zakat may apply depending on your wealth level.",
      portfolio: {
      ...
      returns: {
        ...
        sub: "Paid Annually",
        tooltip:
          "This is the estimated annual profit rate based on the partner bank's historical performance. It is not guaranteed.",
      },
      risk: {
        label: "Risk Level",
        low: "Low",
        ...
        tooltip:
          "Low risk means your principal investment is prioritized for safety, with lower volatility but steady growth.",
      },
    },
    ...
    simulator: {
      ...
      tooltip:
        "This projection assumes consistent monthly deposits and estimated annual returns. Past performance does not guarantee future results.",
      timeHorizon: "Time Horizon",
      ...
      balance: "Balance",
      disclaimer:
        "Estimates only. Not guaranteed. Based on historical market performance and does not predict future returns.",
    },
  ...
  ar: {
    ...
    portfolios: {
      ...
      about: "حول المحافظ",
      aboutDesc:
        "تستثمر جميع المحافظ حصريًا في الأصول المحلية السعودية ومنظمة للامتثال لمبادئ الشريعة. الرسوم منخفضة مع نموذج اشتراك ثابت. هذا عرض توضيحي - المحافظ الفعلية ستدار من قبل محترفين مرخصين.",
    ...
    learn: {
      ...
      whyLearnDesc:
        "فهم أساسيات الاستثمار يساعدك على اتخاذ قرارات مستنيرة والبقاء واثقًا أثناء تغيرات السوق. كل مقال يستغرق ٢-٣ دقائق فقط للقراءة.",
    ...
    investment: {
      ...
      riskDisclosureDesc:
        "بينما استثمارات البنك الشريك عادة ما تكون أقل مخاطرة، الأداء السابق لا يضمن النتائج المستقبلية. لا يتم ضمان الأرباح المتوقعة وقد تختلف بناءً على ظروف السوق. هذا الاستثمار مدعوم من قبل الميزانية العمومية للبنك الشريك والإشراف التنظيمي من قبل ساما.",
      isGuaranteed: "هل هذا استثمار مضمون؟",
      isGuaranteedDesc:
        "الأرباح المتوقعة تعتمد على أداء البنك الشريك. بينما مدعومة من البنك، قد تؤثر ظروف السوق على العائدات.",
      ...
      isShariahCompliantDesc:
        "نعم. جميع الاستثمارات في أدوات متوافقة مع الشريعة الإسلامية مثل الصكوك والسندات الإسلامية المعتمدة من علماء التمويل الإسلامي.",
      howTaxesCalculated: "كيف تُحسب الضرائب؟",
      howTaxesCalculatedDesc:
        "حاليًا، لا توجد ضرائب قابلة للتطبيق على عوائد الاستثمار. قد تنطبق الزكاة حسب مستوى ثروتك.",
      portfolio: {
